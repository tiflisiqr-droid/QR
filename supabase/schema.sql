...
-- Existing projects: add column if the table was created before sort_order existed.
...
-- 1a) Menu categories (Admin → Cuisine → Categories; dish rows reference category_id)
